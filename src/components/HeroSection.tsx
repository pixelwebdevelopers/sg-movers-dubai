      ...
      <div className="relative z-10 container mx-auto px-4 py-12 lg:py-20">
        ...
        <div className="flex justify-center mb-6 animate-slide-up" style={{ animationDelay: "0.1s" }}>
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full glass border border-cta/30 shadow-cta">
            ...
            <span className="text-sm font-semibold text-cta">Special Offer: 30% OFF</span>
            <Sparkles className="w-4 h-4 text-cta" />
          </div>
        </div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-primary-foreground leading-tight mb-6 animate-slide-up" style={{ animationDelay: "0.2s" }}>
            Effortless Moving
          ...
          <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl mx-auto mb-8 animate-slide-up" style={{ animationDelay: "0.3s" }}>
            Professional moving services in Dubai & UAE. Fast, reliable, and affordable. 
            Let us handle the heavy lifting while you relax.
          </p>
          ...
          {/* Trust Indicators */}
          <div className="mt-12 flex flex-wrap justify-center gap-8 animate-slide-up" style={{ animationDelay: "0.5s" }}>
            {[
